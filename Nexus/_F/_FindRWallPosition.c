void _FindRWallPosition(int param_1,int *param_2,int param_3)

{
  ...
  do {
    if ((char)param_2[3] == '\0') {
      uVar4 = ((*param_2 >> 0x10) - local_1c) + 0x10;
      iVar10 = (int)uVar4 >> 7;
      ...
      if ((byte)PTR__Tile128x128_007fe0a0[iVar7 + uVar8 * 0x8000 + 0x40000] < 2) {
        ...
        if (cVar1 == '\x01') {
          if ((char)PTR__TileCollisions_007fe0e0
                    [uVar4 * 0x10 + (uVar6 & 0xf) + uVar8 * 0x11400 + 0x4000] < '@') {
            *param_2 = (iVar10 * 0x80 -
                       (int)(char)PTR__TileCollisions_007fe0e0
                                  [uVar4 * 0x10 + (uVar6 & 0xf) + uVar8 * 0x11400 + 0x4000]) + 0xf  +
                       iVar9 * 0x10;
          ...
          if (-0x40 < (char)puVar3[uVar4 * 0x10 + (uVar6 & 0xf) + uVar8 * 0x11400 + 0x8000]) {
            *param_2 = (int)(char)puVar3[uVar4 * 0x10 + (uVar6 & 0xf) + uVar8 * 0x11400 + 0x8000]  +
          ...
          if (-0x40 < (char)puVar3[uVar4 * 0x10 + (~uVar6 & 0xf) + uVar8 * 0x11400 + 0x8000]) {
            ...
            *(undefined1 *)(param_2 + 3) = 1;
            ...
            goto LAB_00015d69;
                ...
                ((char)puVar3[uVar4 * 0x10 + (~uVar6 & 0xf) + uVar8 * 0x11400 + 0x4000] < '@')) {
          *param_2 = (iVar10 * 0x80 -
                     (int)(char)puVar3[uVar4 * 0x10 + (~uVar6 & 0xf) + uVar8 * 0x11400 + 0x4000])  +
                     0xf + iVar9 * 0x10;
          *(undefined1 *)(param_2 + 3) = 1;
          param_2[2] = (byte)puVar3[((uint)*(byte *)(param_1 + 0x37) * 0x4500 + uVar4) * 4 + 0x100 01
                                   ] + 0x80;
        }
      }
      if ((char)param_2[3] != '\x01') goto LAB_00015e59;
      iVar7 = param_2[2];
      if (iVar7 < 0) {
        iVar7 = iVar7 + 0x100;
        param_2[2] = iVar7;
