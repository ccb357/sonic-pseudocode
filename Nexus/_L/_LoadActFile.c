undefined1 _LoadActFile(int param_1,int param_2,undefined4 param_3)
...
LAB_0000429e:
    ...
    if (_ActiveStageList == '\0') {
      for (iVar4 = 0; local_5c[iVar4] != '\0'; iVar4 = iVar4 + 1) {
      }
      pcVar5 = local_5c + iVar4;
      for (iVar3 = 0; (&_PStageList)[iVar3 + param_2 * 0xc] != '\0'; iVar3 = iVar3 + 1) {
        *pcVar5 = (&_PStageList)[iVar3 + param_2 * 0xc];
        pcVar5 = pcVar5 + 1;
      }
      goto LAB_0000429e;
    }
    if (_ActiveStageList == '\x02') {
      for (iVar4 = 0; local_5c[iVar4] != '\0'; iVar4 = iVar4 + 1) {
      }
      pcVar5 = local_5c + iVar4;
  ...
  local_5c[iVar4] = '\0';
  if (_ActiveStageList == '\x01') {
    puVar7 = &DAT_00026fb8 + param_2 * 0xc;
    for (iVar4 = 0; local_5c[iVar4] != '\0'; iVar4 = iVar4 + 1) {
    }
    pcVar5 = local_5c + iVar4;
    for (iVar3 = 0; puVar7[iVar3] != '\0'; iVar3 = iVar3 + 1) {
      *pcVar5 = puVar7[iVar3];
      pcVar5 = pcVar5 + 1;
    }
  }
  else if (_ActiveStageList == '\0') {
    puVar7 = &DAT_000269b8 + param_2 * 0xc;
    for (iVar4 = 0; local_5c[iVar4] != '\0'; iVar4 = iVar4 + 1) {
    }
    pcVar5 = local_5c + iVar4;
    for (iVar3 = 0; puVar7[iVar3] != '\0'; iVar3 = iVar3 + 1) {
    ...
    puVar7 = &DAT_00022118 + param_2 * 0xc;
    for (iVar4 = 0; local_5c[iVar4] != '\0'; iVar4 = iVar4 + 1) {
    }
    pcVar5 = local_5c + iVar4;
    for (iVar3 = 0; puVar7[iVar3] != '\0'; iVar3 = iVar3 + 1) {
    ...
    if (_ActiveStageList != '\x03') goto LAB_000043df;
    puVar7 = &DAT_00026cb8 + param_2 * 0xc;
    for (iVar4 = 0; local_5c[iVar4] != '\0'; iVar4 = iVar4 + 1) {
    }
    pcVar5 = local_5c + iVar4;
    for (iVar3 = 0; puVar7[iVar3] != '\0'; iVar3 = iVar3 + 1) {
  ...
  _ConvertStringToInteger(puVar7,&_ActNumber);
LAB_000043df:
  for (iVar4 = 0; local_5c[iVar4] != '\0'; iVar4 = iVar4 + 1) {
  }
  pcVar5 = local_5c + iVar4;
